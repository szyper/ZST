...
using _10_kompozycja.Models.Enums;
using _10_kompozycja.Services;
...
car.Engine = new Engine(400, EngineType.Electric);
car.Radio = new Radio(true);

Motorcycle moto = new("Yamaha", 2022, MotorcycleType.Sport);
moto.Engine = new Engine(100, EngineType.Petrol);

Bicycle bike1 = new("Romet", 2025, 21);
Bicycle bike2 = new("Romet", 2000, 21);
