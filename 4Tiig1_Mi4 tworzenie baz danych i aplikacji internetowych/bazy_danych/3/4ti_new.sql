...
--
-- Host: 127.0.0.1
-- Generation Time: Wrz 22, 2025 at 10:43 AM
...
(1, 'admin', 'Pełne uprawnienia', 1, '2025-09-22 00:00:00', '2025-09-22 08:40:00'),
(2, 'user', 'Brak uprawnień do dodawanie użytkwoników', 1, '2025-09-22 10:40:39', '2025-09-22 08:40:53');
...
CREATE TABLE `users` (
  ...
  `gender` enum('mal','female','other') NOT NULL DEFAULT 'other',
...
INSERT INTO `users` (`id`, `firstName`, `lastName`, `email`, `password`, `gender`, `birth_date`, `description`) VALUES
(1, 'Franek', 'Szyper', 'fran@o2.pl', 'pass123!@', 'other', '2000-09-11', ''),
(2, 'Majka', 'Nowak', 'majka@o2.pl', 'pass1234@!', 'other', '2025-09-10', ''),
(3, 'Franek', 'Szyper', 'fran@o2.pl', 'e3d9f6cf3339e26f7397a2563331ce69fe630a76610a3b70c1e1cd7b911cd095', 'other', '2000-09-11', ''),
(4, 'Julia          ', 'Szyper', 'fran@o2.pl', 'e3d9f6cf3339e26f7397a2563331ce69fe630a76610a3b70c1e1cd7b911cd095', 'other', '2000-09-11', ''),
(5, 'noweimie', 'nowenazwisko', 'nowyemail@o2.pl', '123', 'mal', '2025-09-09', ''),
(6, 'noweimie', 'nowenazwisko', 'nowyemail@o2.pl', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'mal', '2025-09-09', '');
...
ALTER TABLE `addresses`
  ...
  ADD CONSTRAINT `addresses_ibfk_2` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`),
  ADD CONSTRAINT `addresses_ibfk_3` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`);
